 ...
 * @author rettig
 */
public class Mean_KIRK_payload_e extends AbstractAnalysis {
    
    public static void main(String[] args) throws Exception {
        AnalysisLauncher.open(new Mean_KIRK_payload_e());
    }
    ...
    public void init() throws FileNotFoundException, IOException  {
        ...
        //try {
            CSVReader csvReader = new CSVReader(new FileReader("C:\\Users\\muellersm\\Desktop\\Neuer Ordner\\e.csv"), ';' ,'"'); 
