 ...
 * @author rettig
 */
public class Mean_KIRK_payload_g extends AbstractAnalysis {
    
    public static void main(String[] args) throws Exception {
        AnalysisLauncher.open(new Mean_KIRK_payload_g());
    }
    ...
    public void init() throws FileNotFoundException, IOException  {
        ...
        //try {
            CSVReader csvReader = new CSVReader(new FileReader("C:\\Users\\muellersm\\Desktop\\Neuer Ordner\\g.csv"), ';' ,'"'); 
